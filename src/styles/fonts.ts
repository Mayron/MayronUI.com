...
const fonts = css`
  /****************************************************/
  // Nunito Sans ExtraBold Only (800)
  /****************************************************/
  ...
  @font-face {
    ...
    src: local("Nunito Sans ExtraBold"), local("NunitoSans-ExtraBold"),
      url("https://fonts.gstatic.com/s/nunitosans/v6/pe03MImSLYBIv1o4X1M8cc8aBc5iU1EQVg.woff2")
        format("woff2");
  ...
  @font-face {
    ...
    font-weight: 800;
    src: local("Nunito Sans ExtraBold"), local("NunitoSans-ExtraBold"),
      url("https://fonts.gstatic.com/s/nunitosans/v6/pe03MImSLYBIv1o4X1M8cc8aBc5jU1EQVg.woff2")
        format("woff2");
  ...
  @font-face {
    ...
    font-weight: 800;
    src: local("Nunito Sans ExtraBold"), local("NunitoSans-ExtraBold"),
      url("https://fonts.gstatic.com/s/nunitosans/v6/pe03MImSLYBIv1o4X1M8cc8aBc5tU1E.woff2")
        format("woff2");
